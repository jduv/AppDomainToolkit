namespace AppDomainToolkit.UnitTests
{
    ...
    public class AppDomainContextUnitTests
    {
        ...
        {
            var target = AppDomainContext<AssemblyLoader, PathBasedAssemblyResolver>.Create();
        ...
        {
            var context = AppDomainContext<AssemblyLoader, PathBasedAssemblyResolver>.Create(null);
        }
        ...
        public void Create_ValidSetupInfo()
        {
            ...
            var target = AppDomainContext<AssemblyLoader, PathBasedAssemblyResolver>.Create(setupInfo);
        ...
        {
            AppDomainContext<AssemblyLoader, PathBasedAssemblyResolver> target;
            using (target = AppDomainContext<AssemblyLoader, PathBasedAssemblyResolver>.Create())
            {
                Assert.IsNotNull(target);
                Assert.IsNotNull(target.Domain);
                Assert.IsNotNull(target.UniqueId);
